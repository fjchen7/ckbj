...
public class MoleculeException extends IllegalArgumentException {
    ...
    public static MoleculeException invalidByteSize(int expectedLength, int actualLength, Class clazz) {
    ...
    public static MoleculeException invalidItemCount(int expectedItemCount, int actualItemCount, Class clazz) {
        return new MoleculeException(String.format(
                "Expect %d but receive %d items for molecule class %s",
                expectedItemCount, actualItemCount, clazz.getSimpleName()));
    }

    public static MoleculeException invalidFieldCount(int expectedFieldCount, int actualFieldCount, Class clazz) {
        return new MoleculeException(String.format(
