...
import io.github.fjchen7.ckbj.molecule.type.concrete.*;
...
class Converter {
    ...
    protected static OutPoint toOutPoint(io.github.fjchen7.ckbj.type.OutPoint in) {
    ...
    protected static CellInput toCellInput(io.github.fjchen7.ckbj.type.CellInput in) {
    ...
    protected static CellInputVec toCellInputVec(List<io.github.fjchen7.ckbj.type.CellInput> in) {
    ...
    protected static CellOutput toCellOutput(Cell in) {
    ...
    protected static CellOutputVec toCellOutputVec(List<Cell> in) {
    ...
    protected static CellDep toCellDep(io.github.fjchen7.ckbj.type.CellDep in) {
    ...
    protected static CellDepVec toCellDepVec(List<io.github.fjchen7.ckbj.type.CellDep> in) {
    ...
    protected static Script toScript(io.github.fjchen7.ckbj.type.Script in) {
        if (in == null) {
            return null;
        }
    ...
    protected static RawTransaction toRawTransaction(io.github.fjchen7.ckbj.type.Transaction in) {
    ...
    protected static Transaction toTransaction(io.github.fjchen7.ckbj.type.Transaction in) {
    ...
    protected static RawHeader toRawHeader(io.github.fjchen7.ckbj.type.Header in) {
    ...
    protected static Header toHeader(io.github.fjchen7.ckbj.type.Header in) {
    ...
    protected static WitnessArgs toWitnessArgs(io.github.fjchen7.ckbj.type.WitnessArgs in) {
    ...
    protected static io.github.fjchen7.ckbj.type.WitnessArgs fromWitnessArgs(WitnessArgs in) {
        io.github.fjchen7.ckbj.type.WitnessArgs witnessArgs = new io.github.fjchen7.ckbj.type.WitnessArgs();
