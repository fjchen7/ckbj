...
public class SignerTest {
    ...
    public void testTransactionSigner() {
        ...
        transactionSigner.register(new Secp256K1Blake160SighashAllSigner(ecKeyPair));
        ...
        transactionSigner.sign(tx, inputDetails);
        Assertions.assertArrayEquals(
                Hex.toByteArray("0x550000001000000055000000550000004100000090b18cc17b8c67e20075ffcffe82d079e0b6a78cb3184157d78962bdd5a648d82c9bc8e1bbe87e7b8b0661440c1060f939be85d26742148e08dc58743a900df41c"),
                tx.getWitnesses().get(0));
    }

    @Test
    public void testSecp256K1Blake160SighashAllSigner() {
        Transaction tx = Transaction.builder()
                .addCellDep(CellDep.DepType.DEP_GROUP, "0xf8de3bb47d055cdf460d93a2a6e1b05f7432f9777c8c474abf4eec1d4aee5d37", 0)
                .addCellDep(CellDep.DepType.DEP_GROUP, "0xec26b0f85ed839ece5f11c4c4e837ec359f5adc4420410f6453b1f6b60fb96a6", 0)
                .addInput("0xbaf3371f487a0d40f8ebc341a34b93a2d36e1d9f77b9533fb8c579c87958b7aa", 0)
                ...
                .build();
        Assertions.assertArrayEquals(
                Hex.toByteArray("0x7be5f1df2c5eb2f33bcf20603774e485c78ab7616e059908715b4a8200e8949f"),
                tx.hash());
        ...
        ECKeyPair ecKeyPair = ECKeyPair.create("0x6fc935dad260867c749cf1ba6602d5f5ed7fb1131f1beb65be2d342e912eaafe");
        Secp256K1Blake160SighashAllSigner signer = new Secp256K1Blake160SighashAllSigner(ecKeyPair);
        signer.sign(tx, inputDetails);
        Assertions.assertArrayEquals(
                Hex.toByteArray("0x550000001000000055000000550000004100000090b18cc17b8c67e20075ffcffe82d079e0b6a78cb3184157d78962bdd5a648d82c9bc8e1bbe87e7b8b0661440c1060f939be85d26742148e08dc58743a900df41c"),
                tx.getWitnesses().get(0));
    }
