...
class Secp256k1Blake160SighashAllTest {
    ...
    public void testCreateArgs() {
        ...
        byte[] args = new Secp256k1Blake160SighashAll.Args(keyPair.getPublicKey()).getArgs();
        Assertions.assertArrayEquals(
                Hex.toByteArray("0xfe48bfb9e83455e0062aa8ef12d03409c494a8f1"),
                args);
        Assertions.assertEquals(
                address,
                new Secp256k1Blake160SighashAll.Args(keyPair.getPublicKey()).toAddress(Network.TESTNET));
    }
