...
class Secp256k1Blake160MultisigAllTest {
    ...
    public void testEncodeDecode() {
        ...
        Secp256k1Blake160MultisigAll.Rule rule = Secp256k1Blake160MultisigAll.Rule.builder()
                .addPublicKeyHash(Hex.toByteArray("0x9b41c025515b00c24e2e2042df7b221af5c1891f"))
                .addPublicKeyHash(Hex.toByteArray("0xe732dcd15b7618eb1d7a11e6a68e4579b5be0114"))
                .setM(2)
                .build();
    ...
    private Transaction getTransaction() {
        ...
        Transaction tx = Transaction.builder()
                ...
                .addOutputs(Cell.builder()
                                    ...
                                    .setData(new byte[]{})
                                    .build())
                .addWitnesses(Hex.toByteArray(""))
                .addWitnesses(Hex.toByteArray("0x1234"))
                .build();
        return tx;
    }
}